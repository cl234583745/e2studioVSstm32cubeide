...
static StaticTask_t new_thread1_memory;
                ...
                static uint8_t new_thread1_stack[1024] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
static uint8_t new_thread1_stack[1024] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.new_thread1") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
#endif
#endif
...
void new_thread1_create(void)
{
    ...
    new_thread1 = xTaskCreateStatic (
                    ...
                    #endif
                                     new_thread1_func,
                                     (const char*) "New Thread1", 1024 / 4, // In words, not bytes
